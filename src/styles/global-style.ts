...
export default createGlobalStyle<{ theme: DefaultTheme }>`
  ...
  * {
  ...
  // #___gatsby and #gatsby-focus-wrapper are some elements generated by Gatsby.
  // Not sure what they're used for, but we have to set their height to 100% too
  // if we want to have full-height page.

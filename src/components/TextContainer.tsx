...
export const TextContainer: React.FC = () => (
  <FullWidthContainer className="relative p-3">
    <article>
      ...
      <p className="text-sm">
        Tietokilta järjestää opiskelijoilleen erilaista vapaa-ajan toimintaa
        niin Otaniemessä kuin sen ulkopuolellakin, valvoo heidän etujaan
        korkeakoulun toimielimissä, huolehtii yhteyksistä muihin
        opiskelijajärjestöihin ja pyrkii muuten huolehtimaan heidän
        hyvinvoinnistaan. Kaikki killan toiminta perustuu hyvien
        teekkariperinteiden mukaiseen vapaaehtoistyöhön ja yhteiseen
        talkoohenkeen.
      </p>
      <p className="text-sm">

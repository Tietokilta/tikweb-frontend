...
type Props = {
  ...
  signup: StringifyApi<SignupGetSignupItem>
  registrationClosed: boolean
}
const EditForm: React.FC<Props> = memo(
  ({ event, signup, registrationClosed }) => {
      ...
      <Formik initialValues={signup as Signup.Update.Body} onSubmit={onSubmit}>
        {({ handleSubmit, isSubmitting }) => (
          <>
            ...
            {registrationClosed && (
              <p className="text-red font-semibold my-2 p-3 rounded-lg border border-red bg-red bg-opacity-20">
                Ilmoittautumistasi ei voi enää muokata tai perua, koska
